...
El administrador de la cuenta `spabienestar` debe activarlo una sola vez:

1. Ir a **Settings → Pages** de este repositorio.
2. En *Build and deployment*, elegir **Deploy from a branch**.
3. Branch: **main** · Carpeta: **/ (root)** → **Save**.

En 1–2 minutos el sitio queda publicado en `https://spabienestar.github.io/brochure/`.
